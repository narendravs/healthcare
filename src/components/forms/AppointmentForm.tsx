  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex flex-col items-center space-y-10 xl:items-start"
      >
        <div className="flex flex-col items-center justify-center space-y-10 xl:items-start">
          {type === "create" && (
          ...
          {type !== "cancel" && (
            <>
              ...
              <div
                className={`flex flex-col gap-6 ${type === "create" && "xl:get-[30%] xl:flex-row"}`}
              >
                <CustomFormField
